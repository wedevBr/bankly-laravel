 ...
 */
class PixCashoutValidatorTest extends TestCase
{
    /**
     * @return BankAccount
     */
    ...
    public function validPixCashout()
    {
        ...
        $pixCashout->addressKey = '123456789';
        $pixCashout->receiverReconciliationId = 'asdfghjklasdfhjklasdfhjkl';
        $pixCashout->endToEndId = 'qwertyuiopqwertyuiop';
     ...
     * @return void
     */
    public function testValidateAddressKey()
    {
        $this->expectException(\InvalidArgumentException::class);
        $this->expectErrorMessage('address key should be a string');
        $pixCashout = $this->validPixCashout();
        $pixCashout->addressKey = null;
        $pixCashout->validate();
    }
     ...
     * @return void
     */
    public function testValidateReceiverReconciliationId()
    {
        $this->expectException(\InvalidArgumentException::class);
        $this->expectErrorMessage('receiver reconciliation id should be a string');
        $pixCashout = $this->validPixCashout();
        $pixCashout->receiverReconciliationId = null;
        $pixCashout->validate();
    }
