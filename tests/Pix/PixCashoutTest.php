 ...
 */
class PixCashoutTest extends TestCase
{
    use WithFaker;
    ...
    public function testSuccessPixCashout()
    {
        ...
        Http::assertSent(function ($request) {
            ...
            return $body['amount'] === '83.23'
                ...
                && $body['addressKey'] === '123456789'
                && $body['receiverReconciliationId'] === 'asdfghjklasdfhjklasdfhjkl'
                && $body['endToEndId'] === 'qwertyuiopqwertyuiop';
        });
